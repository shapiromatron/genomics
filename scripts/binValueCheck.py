...
class BinValueCheck(object):
    ...
    def __init__(self, bin_anchor, bin_start, bin_number, bin_size, feature_bed,
...
def cli(bin_anchor, bin_start, bin_number, bin_size, feature_bed, chrom_sizes,
stranded_bed):
    """
    Check and validate window parameters for analysis.
    """
    BinValueCheck(bin_anchor, bin_start, bin_number, bin_size, feature_bed,
    chrom_sizes, stranded_bed)
